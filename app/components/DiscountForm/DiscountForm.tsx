      ...
      <Layout.Section>
        <Form method="post" id="discount-form">
          ...
          <BlockStack gap="400">
              ...
              <Box>
                <BlockStack gap="100">
                  ...
                  <Text as="p" variant="bodyMd">
                    Select which types of discounts this discount can be combined with.
                  </Text>
                  <Checkbox
                    label="Product discounts"
                    checked={formState.discountClasses.includes(DiscountClass.Product)}
                    onChange={(checked) =>
                  ...
                  <Checkbox
                    ...
                    checked={formState.discountClasses.includes(DiscountClass.Order)}
                    onChange={(checked) =>
                  ...
                  <Checkbox
                    ...
                    checked={formState.discountClasses.includes(DiscountClass.Shipping)}
                    onChange={(checked) =>
            ...
            {/* Discount Configuration section - only show table, highlight primary market, add active checkbox */}
            <Card>
              <Box>
                <BlockStack gap="100">
                  <Text variant="headingMd" as="h2">
                  ...
                  <Text as="p" variant="bodyMd">
                    Configure discount values, dates, exclusions, and activation per market. All values are in the presentment currency for each market.
                  </Text>
